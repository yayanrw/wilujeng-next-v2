  ...
  return (
    <div
      ...
      className={[
        ...
        clickable ? 'cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-800/50 select-none' : 'cursor-default',
    ...
    >
      ...
      {loading ? (
        ...
        <div className={`text-xl font-bold tabular-nums leading-tight ${toneValue[tone]}`}>
          {value}
        </div>
      )}
    </div>
